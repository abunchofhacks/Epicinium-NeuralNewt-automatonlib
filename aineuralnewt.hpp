...
private:
	ConstructorDebugger _cd_ownBaseFloodfill = "_ownBaseFloodfill";
	TileFloodfill _ownBaseFloodfill;
	ConstructorDebugger _cd_enemyBaseFloodfill = "_enemyBaseFloodfill";
	TileFloodfill _enemyBaseFloodfill;
	ConstructorDebugger _cd_pathingFloodfillCache = "_pathingFloodfillCache";
	std::vector<PathingFloodfill> _pathingFloodfillCache; // (married)
	ConstructorDebugger _cd_pathingFloodfillUses = "_pathingFloodfillUses";
	std::vector<Descriptor> _pathingFloodfillUses; // (married)

	ConstructorDebugger _cd_brain = "_brain";
	std::shared_ptr<NewtBrain> _brain;
	ConstructorDebugger _cd_evaluation = "_evaluation";
	NewtBrain::Output _evaluation;

	ConstructorDebugger _cd_settlers = "_settlers";
	std::vector<Descriptor> _settlers;
	ConstructorDebugger _cd_defenses = "_defenses";
